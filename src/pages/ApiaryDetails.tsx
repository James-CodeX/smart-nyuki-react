...
const ApiaryDetails = () => {
  ...
  if (loading) {
    return (
      <div className="md:ml-[250px] container max-w-7xl pt-16 md:pt-8 pb-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center min-h-[60vh]">
  ...
  if (!apiary) {
    return (
      <div className="md:ml-[250px] container max-w-7xl pt-16 md:pt-8 pb-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center min-h-[60vh]">
  ...
  return (
    <PageTransition>
      <div className="md:ml-[250px] transition-all duration-300">
